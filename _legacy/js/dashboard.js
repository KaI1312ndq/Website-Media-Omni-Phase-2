const SVG = {
  ...
  analytics:`<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#9ca3af" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg>`,
...
const DASH_CFG = {
  admin: { badge:'Admin / Lead', badgeClass:'rb-admin', sub:'Bạn có quyền truy cập toàn bộ hệ thống.',
    cards:[
      ...
      { icon:SVG.analytics, title:'Analytics',           desc:'Thống kê performance quiz toàn team.',       badge:'dcb-soon',      label:'Phase 3' },
    ]
  },
